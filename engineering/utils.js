...
exports.assetsPath = function (_path) {
    const assetsSubDirectory = systemConfig.isProduct ? webpackConfig.build.assetsSubDirectory : webpackConfig.dev.assetsSubDirectory;
...
//根路径拼接
exports.resolveJoin = function(dir){
    return path.join(__dirname,"..",dir);
}

// 对象方法容错
exports.objectFaultTolerant = function(path=`config/webpack-config.js`, trycatch={}){
    // 校验文件是否存在
    var prefixurl = exports.resolveJoin(`channels/${systemConfig.projectName}/${path}`),
...
// 数组方法容错
exports.arrayFaultTolerant = function(path, trycatch=[]){
    return exports.objectFaultTolerant(path, trycatch);
}
